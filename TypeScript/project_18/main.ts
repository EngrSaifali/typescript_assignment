...
const countries : string[] = ["South Korea", "Pakistan", "Belgium", "Russia"];
console.log("Original Array : " + countries);

console.log("Copy Array : " + [...countries].sort());
console.log("Original Array : " + countries);

console.log("Copy Array : " + [...countries].sort().reverse());
console.log("Original Array : " + countries);

console.log("Original Array : " + countries.reverse());
console.log("Original Array : " + countries.reverse());

console.log("Original Array : " + countries.sort());
console.log(countries.sort().reverse()); // Original Array as well
